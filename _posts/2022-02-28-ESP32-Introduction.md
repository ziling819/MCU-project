...
Linux: starting with `/dev/tty`<br>
...
* Menuconfigure I2S>
`idf.py menuconfig`<br>
`A2DP Example Configuration --->`<br>

*press Enter to see below*<br>
```
...
* programming ESP32-S
`idf.py build`<br>
**press IO0 button to GND and press RESET button to GND**<br>
